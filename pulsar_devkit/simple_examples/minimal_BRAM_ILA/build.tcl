...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../HLSIPs/proj0"]" $obj
...
# Set IP repository paths
#set obj [get_filesets simple_algo_hw_0]
#set_property "ip_repo_paths" "[file normalize "$origin_dir/../HLSIPs/proj0"]" $obj
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/cgn/simple_algo_hw_0/simple_algo_hw_0.xci"]"\
]
add_files -norecurse -fileset $obj $files
