...
create_project test_stream ../vivado/test_stream_prj -part xc7z020clg484-1
set_property board_part em.avnet.com:zed:part0:1.3 [current_project]
set_property target_language VHDL [current_project]
create_bd_design "test_stream_hw"
set_property ip_repo_paths [list ../example_transfer/basic_stream_prj/solution1/impl/ip/ ../vivado/timer_subsystem/] [current_fileset]
update_ip_catalog
# clear
...
#DNN
create_bd_cell -type ip -vlnv xilinx.com:hls:basic_stream:1.0 basic_stream
#set_property -dict [list CONFIG.C_S_AXI_CONTROL_BUS_ADDR_WIDTH {32}] [get_bd_cells basic_stream]
...
connect_bd_net -net [get_bd_nets processing_system7_fclk_clk0] [get_bd_pins basic_stream/ap_clk]      [get_bd_pins processing_system7/FCLK_CLK0]
...
connect_bd_net [get_bd_pins basic_stream/interrupt] [get_bd_pins coalesce_interrupts/In1]
...
connect_bd_net -net [get_bd_nets proc_sys_reset_peripheral_aresetn] [get_bd_pins basic_stream/ap_rst_n] [get_bd_pins proc_sys_reset/peripheral_aresetn]
...
connect_bd_intf_net [get_bd_intf_pins basic_stream/in_stream] [get_bd_intf_pins DMA_controller/M_AXIS_MM2S]
connect_bd_intf_net [get_bd_intf_pins basic_stream/out_stream] [get_bd_intf_pins DMA_controller/S_AXIS_S2MM]
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config {Master "/processing_system7/M_AXI_GP0" Clk "Auto" }  [get_bd_intf_pins basic_stream/s_axi_CTRL_BUS]

validate_bd_design
#Finish it up
make_wrapper -files [get_files ../vivado/test_stream_prj/test_stream.srcs/sources_1/bd/test_stream_hw/test_stream_hw.bd] -top
add_files -norecurse           ../vivado/test_stream_prj/test_stream.srcs/sources_1/bd/test_stream_hw/hdl/test_stream_hw_wrapper.vhd
